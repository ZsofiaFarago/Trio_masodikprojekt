...
<html>
  <head>
  <link rel="stylesheet" href="<?=PUBLIC_DIR.'css/Snake_Style.css'?>">
  	<title>Snake Game</title>
  </head>

  <body>
  <div>
			<?php require_once PROTECTED_DIR.'services/freetime/routing.php'; ?>
		</div>
    <table id="pictab">
  <tr>
        
        <th id="pic"><img src=<?=PUBLIC_DIR.'Images/Snake_logo.png'?>></th>
